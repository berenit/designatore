                                ...
                                @foreach ($designations as $designation)
                                    <div class="flex items-center gap-2 py-0.5 flex-wrap group">
                                        ...
                                        <span class="inline-flex items-center opacity-0 group-hover:opacity-100 transition">
                                            ...
                                            <form action="{{ route('designations.destroy', $designation) }}" method="POST" x-data class="contents" @submit.prevent="$store.confirmModal.ask('Eliminare questa designazione?', $el)">
                                                @csrf @method('DELETE')
