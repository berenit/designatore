        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select id="availability_status" name="availability_status" required
                    ...
                    <option value="">Seleziona...</option>
                    <option value="available" {{ old('availability_status', $referee->availability_status) === 'available' ? 'selected' : '' }}>Disponibile</option>
                    <option value="limited" {{ old('availability_status', $referee->availability_status) === 'limited' ? 'selected' : '' }}>Limitata</option>
                    <option value="unavailable" {{ old('availability_status', $referee->availability_status) === 'unavailable' ? 'selected' : '' }}>Non disponibile</option>
                </select>
