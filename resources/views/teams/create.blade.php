...
<div class="max-w-xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Nuova Squadra</h1>
    ...
    <form action="{{ route('teams.store') }}" method="POST"
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input id="league_division" type="text" name="league_division" value="{{ old('league_division') }}" required
        ...
        <div class="flex items-center justify-between pt-2">
            ...
            <a href="{{ route('teams.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Annulla</a>
        </div>
    </form>
</div>
@endsection
